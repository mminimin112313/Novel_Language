...
export async function crop(inputPath, outputPath, rect) {
    await sharp(inputPath)
        .extract(rect)
        .toFile(outputPath);
    console.log(`[Vision] Cropped image saved to ${outputPath}`);
}
export async function analyzeText(inputPath) {
...
export async function stitchImages(inputPaths, outputPath, direction = 'vertical') {
